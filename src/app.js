import { heroes as INITIAL_HEROES } from '../heroes.js';
import { INITIAL_MATERIALS } from './data/materials.js';


const { useState, useEffect, useRef } = React;

// --- SISTEMA DE ICONOS INTERNO (SVG PATHS) ---
// Esto elimina la dependencia externa que estaba fallando.
const Icons = {
...
const RARITY_COLORS = {
    ...
    Uncommon: 'text-emerald-400 border-emerald-600 bg-emerald-950',
    Rare: 'text-blue-400 border-blue-600 bg-blue-950',
    Mythical: 'text-purple-400 border-purple-600 bg-purple-950', 
    Legendary: 'text-yellow-400 border-yellow-600 bg-yellow-950', 
    Immortal: 'text-red-400 border-red-600 bg-red-950',
};
...
function App() {
    ...
    const [heroViewMode, setHeroViewMode] = useState('grid'); 
    ...
    return (
        ...
        <header className="bg-slate-900 border-b border-slate-800 sticky top-0 z-50 shadow-xl h-16 flex items-center justify-between px-4">
            <div className="flex items-center space-x-3">
                ...
                <div>
                <h1 className="text-lg font-bold text-white leading-tight tracking-tight hidden md:block">Dota x Monter Hunter</h1>
