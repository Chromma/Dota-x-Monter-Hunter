...
window.TRANSLATIONS = {
    es: {
        ...
        config_view_desc: "Elige cómo visualizar tus tarjetas de progreso.",
        config_backup_title: "Copia de Seguridad (Cloud Simulado)",
        config_save_title: "Guardar Progreso",
        config_save_desc: "Descarga un archivo con todo tu avance actual.",
        config_save_btn: "DESCARGAR JSON",
        config_load_title: "Cargar Progreso",
        config_load_desc: "Sube el archivo JSON para restaurar tus datos.",
        config_load_btn: "SUBIR JSON",
        config_reset_title: "Restaurar Datos de Fábrica",
        config_reset_desc: "Recuperar la configuración original extraída de los archivos CSV.",
        config_reset_btn: "Restaurar Originales",
        config_mats_title: "Gestión de Materiales",
    ...
    en: {
        ...
        config_view_desc: "Choose how to display your progress cards.",
        config_backup_title: "Backup (Simulated Cloud)",
        config_save_title: "Save Progress",
        config_save_desc: "Download a file with your current progress.",
        config_save_btn: "DOWNLOAD JSON",
        config_load_title: "Load Progress",
        config_load_desc: "Upload the JSON file to restore your data.",
        config_load_btn: "UPLOAD JSON",
        config_reset_title: "Factory Reset",
        config_reset_desc: "Recover original configuration extracted from CSV files.",
        config_reset_btn: "Restore Originals",
        config_mats_title: "Material Management",
        config_sets_title: "Sets & Pieces Editor",
        config_add_btn: "Add",
