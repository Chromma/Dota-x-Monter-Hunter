        ...
        <div className="bg-slate-900 border border-slate-800 rounded-xl p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="bg-slate-950 p-4 rounded border border-slate-800 flex flex-col items-center text-center">
                    ...
                    className="w-full py-2 bg-emerald-600 hover:bg-emerald-500 text-white rounded text-xs font-bold">SUBIR JSON</button>
                </div>
            </div>
        </div>
...
return (
    ...
    <header className="bg-slate-900 border-b border-slate-800 sticky top-0 z-50 shadow-xl h-16 flex items-center justify-between px-4">
        <div className="flex items-center space-x-3">
            ...
            <div>
            <h1 className="text-lg font-bold text-white leading-tight tracking-tight hidden md:block">CROWNFALL</h1>
